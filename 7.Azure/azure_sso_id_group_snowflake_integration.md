...
- SCIM provision is a set of general rule help Snowflake manage user, role and assign role base on information from entra. how to create SCIM provisioning
    + snowflake: create role and SCIM provisioning, token for entra call
    + entra: config provisioning
